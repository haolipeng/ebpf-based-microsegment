...
// input: statistics query requests
// output: eBPF map statistics JSON
// pos: statistics API handlers - if file updated, must sync with this header comment and pkg/api/CLAUDE.md
package handlers
