...
type PolicyRequest struct {
	...
	Direction string `json:"direction" binding:"omitempty,oneof=any ingress egress"` // ✅ New: optional direction field
...
type PolicyResponse struct {
	...
	Direction string `json:"direction"` // ✅ New: direction field
	Priority  uint16 `json:"priority"`
}
