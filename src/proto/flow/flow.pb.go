...
const file_flow_proto_rawDesc = "" +
	...
	"\x0eGetFlowSummary\x12%.microsegment.flow.FlowSummaryRequest\x1a\x1e.microsegment.flow.FlowSummaryB-Z+github.com/ebpf-microsegment/src/proto/flowb\x06proto3"
